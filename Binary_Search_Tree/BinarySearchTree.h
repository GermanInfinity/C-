...
public:
        ...
        //void insert_now(int value, Node *parent) const;
...
private:
        ...
        // These are additional function helpers I created, to
        // ensure I have cleaner code. Insert_now, inserts a node into
        // the the tree, it takes a string that tells it to insert on the 
        // right or left. Insert base, inserts a base to the tree. 
        Node *insert_now(int value, Node *parent, string side);
        void insert_base(int value);
        bool one_child_remove(Node *node, Node *parent, bool check);
        bool two_child_remove(Node *node);
